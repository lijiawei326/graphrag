...
class InputDefaults:
    ...
    metadata: None = None
    local_output_dir: None = None
    mineru_api_url: None = None
    mineru_output_dir: None = None
    table_description_api_key: None = None
    table_description_model: None = None
    base_url: None = None   
    image_description_api_key: None = None
    image_description_model: None = None
    image_description_base_url: None = None
