...
def load_strategy(strategy: ChunkStrategyType) -> ChunkStrategy:
    ...
    match strategy:
        ...
        case ChunkStrategyType.markdown:
            # Markdown
            from graphrag.index.operations.chunk_text.markdown_strategy import run_markdown

            return run_markdown
        
        case ChunkStrategyType.csv:
            # CSV
            from graphrag.index.operations.chunk_text.csv_strategy import run_csv
