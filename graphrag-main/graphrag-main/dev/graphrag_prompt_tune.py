...
# GraphRAG项目根目录路径
PROJECT_DIR = "C:\\Users\\lijiawei\\Desktop\\ai-agent\\graphrag"
...
# 输出目录
OUTPUT_DIR = "C:\\Users\\lijiawei\\Desktop\\ai-agent\\graphrag\\data\\prompt_turn_output"
...
async def run_prompt_tune(
    ...
    try:
        ...
        input_files = list(input_dir.glob("**/honglou.txt"))
